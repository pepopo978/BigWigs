...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_boonFade"]) then
		...
		if boonFadePlayer == "you" then
			boonFadePlayer = UnitName("Player")
		end
...
function module:EmpoweredSoul(rest)
	...
	self:SetCandyBarOnClick("BigWigsBar " .. rest .. L["bar_empoweredSoul"] .. " >Click Me<", function(name, button, extra)
