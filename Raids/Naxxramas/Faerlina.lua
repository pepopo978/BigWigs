...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_mcGainYou = BigWigs.AURAHELPFULSELF_PREFIX .. "Mind Control.", --CHAT_MSG_SPELL_PERIODIC_SELF_BUFFS
...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_mcFade"]) then
		...
		if mcEndPriest == "you" then
			mcEndPriest = UnitName("Player")
		end
...
function module:CheckForSuccess()
	...
	if (bwFaerlinaEnragedFadedTime + 5) > GetTime() then
		return
	end
