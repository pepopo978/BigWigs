...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_manaBurn = "Heigan the Unclean(%s?)'s Mana Burn", --CHAT_MSG_SPELL_CREATURE_VS_CREATURE_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_PARTY_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE
		bar_manaBurn = "Mana Burn CD",

		trigger_manaBurnYou = "Heigan the Unclean(%s?)'s Mana Burn" .. BigWigs.COMBATHITOTHERSELF_SUFFIX, --CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE
