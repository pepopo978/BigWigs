...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_mcYou = BigWigs.AURAHELPFULSELF_PREFIX .. "Mind Control.", --CHAT_MSG_SPELL_PERIODIC_SELF_BUFFS
		trigger_mcFadeYou = "Mind Control" .. BigWigs.AURAREMOVEDSELF_SUFFIX, --CHAT_MSG_SPELL_AURA_GONE_SELF
		mc_bar = " MC",
