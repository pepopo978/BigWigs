...
function module:OnEngage()
	if self.core:IsModuleActive("Qiraji Brainwasher", "Ahn'Qiraj") then
		self.core:DisableModule("Qiraji Brainwasher", "Ahn'Qiraj")
	end
	if self.core:IsModuleActive("The Prophet Skeram", "Ahn'Qiraj") then
		self.core:DisableModule("The Prophet Skeram", "Ahn'Qiraj")
	end
...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_mindFlayFade"]) then
		...
		if mindFlayFadePlayer == "you" then
			mindFlayFadePlayer = UnitName("Player")
		end
