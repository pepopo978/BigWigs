...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_markOfKazzakFade"]) then
		...
		if markOfKazzakFadePlayer == "you" then
			markOfKazzakFadePlayer = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_twistedReflectionFade"]) then
		...
		if twistedReflectionFadePlayer == "you" then
			twistedReflectionFadePlayer = UnitName("Player")
		end
