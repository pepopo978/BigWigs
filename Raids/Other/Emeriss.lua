...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_volatileInfectionYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Volatile Infection", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
...
function module:OnEngage()
	if self.core:IsModuleActive("Ysondre", "Ashenvale") then
		self.core:DisableModule("Ysondre", "Ashenvale")
	end
...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_volatileInfectionFade"]) then
		...
		if volatileInfectionFadePlayer == "you" then
			volatileInfectionFadePlayer = UnitName("Player")
		end
