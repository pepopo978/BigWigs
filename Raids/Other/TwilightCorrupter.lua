...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_creatureOfNightmareFade"]) then
		...
		if targetMcFade == "you" then
			targetMcFade = UnitName("Player")
		end
...
function module:CreatureOfNightmare(rest)
	...
	self:SetCandyBarOnClick("BigWigsBar " .. rest .. " " .. L["bar_creatureOfNightmareAfflic"] .. " >Click Me!<", function(name, button, extra)
