...
L:RegisterTranslations("enUS", function()
	return {
		...
		--self
		trigger_tailSweepYou = "Tail Sweep" .. BigWigs.COMBATHITOTHERSELF_SUFFIX, --CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE
		...
		trigger_noxiousBreathYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Noxious Breath", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
		...
		trigger_curseOfThornsYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Curse of Thorns.", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
...
function module:OnEngage()
	...
	if self.core:IsModuleActive("Lethon", "Ashenvale") then
		self.core:DisableModule("Lethon", "Ashenvale")
	end
	if self.core:IsModuleActive("Taerar", "Ashenvale") then
		self.core:DisableModule("Taerar", "Ashenvale")
	end
	if self.core:IsModuleActive("Emeriss", "Ashenvale") then
		self.core:DisableModule("Emeriss", "Ashenvale")
	end
...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_noxiousBreathFade"]) then
		...
		if noxiousBreathFadePlayer == "you" then
			noxiousBreathFadePlayer = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_curseOfThornsFade"]) then
		...
		if curseOfThornsFadePlayer == "you" then
			curseOfThornsFadePlayer = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_silenceFade"]) then
		...
		if silenceFadePlayer == "you" then
			silenceFadePlayer = UnitName("Player")
		end
