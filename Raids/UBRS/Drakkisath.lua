...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_conflagProxy = "Conflagration" .. BigWigs.COMBATHITOTHERSELF_SUFFIX, --CHAT_MSG_SPELL_HOSTILEPLAYER_DAMAGE
...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_conflagFade"]) then
		...
		if conflagFadePlayer == "you" then
			conflagFadePlayer = UnitName("Player")
		end
