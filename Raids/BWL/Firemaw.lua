...
L:RegisterTranslations("enUS", function() return {
	...
	flamebuffetresisted_trigger = "Firemaw(%s?)'s Flame Buffet was resisted",
	flamebuffetimmune_trigger = "Firemaw(%s?)'s Flame Buffet fail(.+) immune\.",
	flamebuffetabsorb1_trigger = BigWigs.ABSORB_PREFIX .. "Firemaw(%s?)'s Flame Buffet",
	flamebuffetabsorb2_trigger = "Firemaw(%s?)'s Flame Buffet is absorbed",
