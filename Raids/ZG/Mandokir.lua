...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_charge = "Bloodlord Mandokir(%s?)'s Charge", --CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_PARTY_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_CREATURE_DAMAGE
		...
		trigger_sunderYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Sunder Armor %((.+)%)", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
...
function module:Event(msg)
	if string.find(msg, L["trigger_gazeFade"]) then
		...
		if gazeFadePlayer == "you" then
			gazeFadePlayer = UnitName("Player")
		end
