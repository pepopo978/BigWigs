...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_holyFireYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Holy Fire", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
		...
		trigger_holyWrath = "High Priest Venoxis(%s?)'s Holy Wrath", --CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_PARTY_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_CREATURE_DAMAGE
		bar_holyWrathCd = "Holy Wrath CD",

		trigger_holyNova = "High Priest Venoxis(%s?)'s Holy Nova", --CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_PARTY_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_CREATURE_DAMAGE
		...
		trigger_poisonCloudYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Poison Cloud", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
		...
		trigger_venomSpit = "High Priest Venoxis(%s?)'s Venom Spit hits (.+) for", --CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_PARTY_DAMAGE // CHAT_MSG_SPELL_CREATURE_VS_CREATURE_DAMAGE
...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_holyFireYou"]) then
	...
	elseif string.find(msg, L["trigger_holyFireFade"]) then
		...
		if holyFireFadePerson == "you" then
			holyFireFadePerson = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_venomSpit"]) then
		...
		if venomSpitPerson == "you" then
			venomSpitPerson = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_venomSpitFade"]) then
		...
		if venomSpitFadePerson == "you" then
			venomSpitFadePerson = UnitName("Player")
		end
		self:Sync(syncName.venomSpitFade .. " " .. venomSpitFadePerson)


	elseif string.find(msg, L["trigger_poisonCloudYou"]) and self.db.profile.poisoncloud then
		self:PoisonCloudYou()
	elseif string.find(msg, L["trigger_poisonCloudYouFade"]) and self.db.profile.poisoncloud then
