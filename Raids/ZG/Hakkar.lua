...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_aspectOfJeklikResist = "Hakkar(%s?)'s Aspect of Jeklik", --guessing ???
		...
		trigger_aspectOfVenoxis = "Hakkar(%s?)'s Aspect of Venoxis hit", --guessing ???
		trigger_aspectOfVenoxisResist = "Hakkar(%s?)'s Aspect of Venoxis was resisted", --guessing ???
