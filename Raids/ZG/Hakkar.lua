...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_causeInsanityFade"]) then
		...
		if causeInsanityFadePerson == "you" then causeInsanityFadePerson = UnitName("Player") end
	...
	elseif string.find(msg, L["trigger_aspectOfMarliFade"]) then
		...
		if marliFadePerson == "you" then marliFadePerson = UnitName("Player") end
	...
	elseif string.find(msg, L["trigger_aspectOfArlokkFade"]) then
		...
		if arlokkFadePerson == "you" then arlokkFadePerson = UnitName("Player") end
...
function module:CauseInsanity(rest)
	...
	if rest == "Grounded!" then
		...
		self:SetCandyBarOnClick("BigWigsBar "..rest..L["bar_causeInsanity"].. " >Click Me<", function(name, button, extra) TargetByName(extra, true) end, rest)
