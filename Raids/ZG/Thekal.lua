...
function module:Event(msg)
	...
	elseif string.find(msg, L["trigger_silenceFade"]) then
		...
		if silenceFadePerson == "you" then
			silenceFadePerson = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_disarmFade"]) then
		...
		if disarmFadePerson == "you" then
			disarmFadePerson = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_blindFade"]) then
		...
		if blindFadePerson == "you" then
			blindFadePerson = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_gougeFade"]) then
		...
		if gougeFadePerson == "you" then
			gougeFadePerson = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_mortalCleaveFade"]) then
		...
		if mortalCleaveFadePerson == "you" then
			mortalCleaveFadePerson = UnitName("Player")
		end
