...
L:RegisterTranslations("enUS", function()
	return {
		...
		trigger_markYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Mark of Arlokk", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
		...
		trigger_ravageYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Ravage", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
		...
		trigger_swpYou = BigWigs.AURAHARMFULSELF_PREFIX .. "Shadow Word: Pain", --CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE
...
function module:Event(msg)
	if string.find(msg, L["trigger_markYou"]) then
	...
	elseif string.find(msg, L["trigger_markFade"]) then
		...
		if markFadePlayer == "you" then
			markFadePlayer = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_ravageYou"]) then
	...
	elseif string.find(msg, L["trigger_ravageFade"]) then
		...
		if ravageFadePlayer == "you" then
			ravageFadePlayer = UnitName("Player")
		end
	...
	elseif string.find(msg, L["trigger_gougeFade"]) then
		...
		if gougeFadePlayer == "you" then
			gougeFadePlayer = UnitName("Player")
		end
		self:Sync(syncName.gougeFade .. " " .. gougeFadePlayer)


	elseif string.find(msg, L["trigger_swpYou"]) then
	...
	elseif string.find(msg, L["trigger_swpFade"]) then
		...
		if swpFadePlayer == "you" then
			swpFadePlayer = UnitName("Player")
		end
...
function module:Mark(rest)
	...
	self:SetCandyBarOnClick("BigWigsBar " .. rest .. L["bar_mark"] .. " >Click Me<", function(name, button, extra)
