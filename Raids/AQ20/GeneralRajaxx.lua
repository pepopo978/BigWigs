...
function module:OnEngage()
	...
	self:SetCandyBarOnClick("BigWigsBar " .. "Target Andorov", function(name, button, extra)
		TargetByName("Lieutenant General Andorov", true)
	end, rest)
end
...
function module:AttackOrder(rest)
	...
	self:SetCandyBarOnClick("BigWigsBar " .. rest .. L["bar_attackOrder"] .. " >Click Me<", function(name, button, extra)
