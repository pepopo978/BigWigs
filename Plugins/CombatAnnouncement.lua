...
function BigWigsCombatAnnouncement:AnnounceAbility(msg, target, spellName)
    ...
    -- Only send whisper if the target is friendly and not self
    if self.db.profile.broadcastwhisper and target and UnitIsFriend("player", "target") and not UnitIsUnit("player", "target") and UnitIsPlayer("target") then
