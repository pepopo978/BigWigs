...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		pummel = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.pummel end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.pummel = v end,
		},
		taunt = {
			type = "toggle",
			name = "Taunt",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.taunt end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.taunt = v end,
		},
		disarm = {
			type = "toggle",
			name = "Disarm",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.disarm end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.disarm = v end,
		},
		challengingshout = {
			type = "toggle",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.challengingshout end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.challengingshout = v end,
		},
		intimidatingshout = {
			type = "toggle",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.intimidatingshout end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.intimidatingshout = v end,
		},
		concussionblow = {
			type = "toggle",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.concussionblow end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.concussionblow = v end,
		},
		spacer = {
			type = "header",
			name = " ",
		...
		broadcastsay = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.broadcastsay end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.broadcastsay = v end,
		},
		broadcastparty = {
			type = "toggle",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.broadcastparty end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.broadcastparty = v end,
		},
		broadcastraid = {
			type = "toggle",
			name = "Broadcast Raid",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.broadcastraid end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.broadcastraid = v end,
		},
		broadcastbg = {
			type = "toggle",
			name = "Broadcast BG",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.broadcastbg end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.broadcastbg = v end,
		},
	}
}
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		kick = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.kick end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.kick = v end,
		},
		kidneyshot = {
			type = "toggle",
			name = "Kidney Shot",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.kidneyshot end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.kidneyshot = v end,
		},
		cheapshot = {
			type = "toggle",
			name = "Cheapshot",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.cheapshot end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.cheapshot = v end,
		},
		blind = {
			type = "toggle",
			name = "Blind",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.blind end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.blind = v end,
		},
		gouge = {
			type = "toggle",
			name = "Gouge",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.gouge end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.gouge = v end,
		},
		spacer = {
			type = "header",
			name = " ",
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		pounce = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.pounce end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.pounce = v end,
		},
		bash = {
			type = "toggle",
			name = "Bash",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.bash end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.bash = v end,
		},
		growl = {
			type = "toggle",
			name = "Growl",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.growl end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.growl = v end,
		},
		spacer = {
			type = "header",
			name = " ",
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		wyvernsting = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.wyvernsting end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.wyvernsting = v end,
		},
		scattershot = {
			type = "toggle",
			name = "Scatter Shot",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.scattershot end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.scattershot = v end,
		},
		tranquilshot = {
			type = "toggle",
			name = "Tranquil Shot",
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.tranquilshot end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.tranquilshot = v end,
		},
		spacer = {
			type = "header",
			name = " ",
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		counterspell = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.counterspell end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.counterspell = v end,
		},
		spacer = {
			type = "header",
			name = " ",
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		hammerofjustice = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.hammerofjustice end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.hammerofjustice = v end,
		},
		spacer = {
			type = "header",
			name = " ",
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		psychicscream = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.psychicscream end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.psychicscream = v end,
		},
		spacer = {
			type = "header",
			name = " ",
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		earthshock = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.earthshock end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.earthshock = v end,
		},
		spacer = {
			type = "header",
			name = " ",
...
BigWigsCombatAnnouncement.consoleOptions = {
	...
	args   = {
		deathcoil = {
			...
			get = function() return BigWigsCombatAnnouncement.db.profile.deathcoil end,
			set = function(v) BigWigsCombatAnnouncement.db.profile.deathcoil = v end,
		},
		spacer = {
			type = "header",
			name = " ",
