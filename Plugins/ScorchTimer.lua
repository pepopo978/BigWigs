...
BigWigsScorchTimer.consoleOptions = {
	...
	args = {
		enable = {
			...
			order = 1,
			get = function()
				return BigWigsScorchTimer.db.profile.enable
			end,
			set = function(v)
				BigWigsScorchTimer.db.profile.enable = v
			end,
		},
		currentonly = {
			type = "toggle",
			...
			order = 2,
			get = function()
				return BigWigsScorchTimer.db.profile.currentonly
			end,
			set = function(v)
				BigWigsScorchTimer.db.profile.currentonly = v
			end,
		},
		spacer = {
			type = "header",
		...
		anchor = {
			...
			order = 5,
			func = function()
				BigWigsScorchTimer:ShowAnchors()
			end,
		},
		reset = {
			type = "execute",
			...
			order = 6,
			func = function()
				BigWigsScorchTimer:ResetAnchor()
			end,
		},
		spacer2 = {
			type = "header",
		...
		growup = {
			...
			order = 13,
			get = function()
				return BigWigsScorchTimer.db.profile.growup
			end,
			set = function(v)
		...
		reverse = {
			...
			order = 14,
			get = function()
				return BigWigsScorchTimer.db.profile.reverse
			end,
			set = function(v)
				BigWigsScorchTimer.db.profile.reverse = v
			end,
			--passValue = "reverse",
		},
		scale = {
			...
			step = 0.1,
			get = function()
				return BigWigsScorchTimer.db.profile.scale
			end,
			set = function(v)
				BigWigsScorchTimer.db.profile.scale = v
			end,
		},
		texture = {
			type = "text",
			...
			order = 16,
			get = function()
				return BigWigsScorchTimer.db.profile.texture
			end,
			set = function(v)
				BigWigsScorchTimer.db.profile.texture = v
			end,
...
function BigWigsScorchTimer:StartBar(text, time, icon)
	...
	candybar:SetCandyBarIcon(id, icon, 4)
